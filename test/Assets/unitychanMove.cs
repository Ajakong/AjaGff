...
public class unitychanMove : MonoBehaviour
{
    ...
    //以降テスト
    public GameObject playerCamera = null; // プレーヤーのカメラ
    ...
    void Update()
    {
        ...
        //if(jumpFlag)
        //{
        //    playerCamera.transform.position = new Vector3(transform.position.x, playerCamera.transform.position.y, transform.position.z - 4);
        //}
        //else
        //{

        //    playerCamera.transform.position = new Vector3(transform.position.x, transform.position.y + 4f, transform.position.z - 4);
    ...
    void FixedUpdate()
    {
        ...
        {
            myRb.position += move1;
            playerCamera.transform.position += move1;
        }
        ...
        if (moveRightFlag)
        {
            ...
            transform.rotation = Quaternion.AngleAxis(rotate, angle);
            //myRb.position += move2;
        }
